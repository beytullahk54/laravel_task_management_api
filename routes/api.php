...
Route::post('teams/{id?}/members', [TeamController::class, 'memberCreate'])->middleware('auth:sanctum');
Route::delete('teams/{id?}/members/{user_id?}', [TeamController::class, 'memberDelete'])->middleware('auth:sanctum');
